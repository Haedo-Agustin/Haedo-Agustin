...
const AgustinHaedo = {
  ...
  focus: "Scalable web applications and clean APIs",
  stack: ["React", "Next.js", "Node.js", "PostgreSQL", "MongoDB", "C++", "C#", "Python", "Git"],
  strengths: ["Clean Code", "Automation", "Maintainable Architecture"],
  goal: "Grow professionally by delivering high-impact solutions"
};
```
